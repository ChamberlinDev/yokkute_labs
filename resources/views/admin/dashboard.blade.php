...
<div class="row g-4 mb-4">
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card card-soft p-4 h-100"><p class="text-muted mb-2">Membres equipe</p><h2 class="mb-0">{{ $stats['team'] }}</h2></div>
    </div>
    <div class="col-md-6 col-xl-3">
        <div class="card card-soft p-4 h-100"><p class="text-muted mb-2">Candidatures</p><h2 class="mb-0">{{ $stats['candidatures'] }}</h2></div>
    </div>
    <div class="col-md-6 col-xl-3">
        <div class="card card-soft p-4 h-100"><p class="text-muted mb-2">Messages contact</p><h2 class="mb-0">{{ $stats['contactMessages'] }}</h2></div>
    </div>
    <div class="col-md-6 col-xl-3">
        <div class="card card-soft p-4 h-100 border-warning-subtle"><p class="text-muted mb-2">Evenements securite</p><h2 class="mb-0 text-warning">{{ $stats['securityEvents'] }}</h2></div>
    </div>
    <div class="col-md-6 col-xl-3">
        <div class="card card-soft p-4 h-100 border-danger-subtle"><p class="text-muted mb-2">Echecs login admin (jour)</p><h2 class="mb-0 text-danger">{{ $stats['failedLoginsToday'] }}</h2></div>
    </div>
</div>
...
<div class="row g-4 mb-4">
    <div class="col-md-6">
        <div class="card card-soft p-4 h-100 border-success-subtle">
            <p class="text-muted mb-2">A traiter aujourd'hui (candidatures)</p>
    ...
    <div class="col-md-6">
        <div class="card card-soft p-4 h-100 border-info-subtle">
            <p class="text-muted mb-2">A traiter aujourd'hui (messages)</p>
            <div class="d-flex justify-content-between align-items-center">
...
<div class="row g-4">
    <div class="col-xl-6">
        <div class="card card-soft p-4 h-100">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h2 class="h5 mb-0">Dernieres candidatures</h2>
    ...
    <div class="col-xl-6">
        <div class="card card-soft p-4 h-100">
            ...
            <div class="table-responsive">
                <table class="table align-middle mb-0">
                    <thead><tr><th>Expediteur</th><th>Besoin</th><th>Statut</th></tr></thead>
                    <tbody>
...
<div class="row g-4 mt-1">
    <div class="col-12">
        <div class="card card-soft p-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h2 class="h5 mb-0">Activite admin recente</h2>
            ...
            <div class="table-responsive">
                <table class="table align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr><td colspan="6" class="text-muted">Aucun evenement de securite journalise pour le moment.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
