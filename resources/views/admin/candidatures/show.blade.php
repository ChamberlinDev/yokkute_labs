        ...
        <div class="card card-soft p-4">
            <div class="d-flex justify-content-between align-items-start gap-3 mb-4">
                <div>
                    ...
                    <p class="text-muted mb-0">{{ $candidature->email }} @if($candidature->telephone) · {{ $candidature->telephone }} @endif</p>
                </div>
            ...
            <dl class="row mb-4">
                ...
                <dt class="col-sm-3">Experience</dt><dd class="col-sm-9">{{ $candidature->experience }}</dd>
                <dt class="col-sm-3">Portfolio</dt><dd class="col-sm-9">{{ $candidature->portfolio ?: 'Non renseigne' }}</dd>
                <dt class="col-sm-3">CV</dt><dd class="col-sm-9">@if($candidature->cv_path)<a href="{{ route('admin.candidatures.cv.download', $candidature) }}">Telecharger le CV</a>@else Aucun fichier @endif</dd>
            </dl>
