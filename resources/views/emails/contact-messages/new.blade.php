...
<body style="font-family: Arial, sans-serif; color: #1f2937; line-height: 1.6;">
    <h2 style="margin-bottom: 8px;">Nouveau message contact</h2>
    <p style="margin-top: 0;">Un nouveau message a ete soumis depuis la page Contact.</p>

    <ul style="padding-left: 18px;">
        <li><strong>Nom:</strong> {{ $contactMessage->prenom }} {{ $contactMessage->nom }}</li>
        <li><strong>Email:</strong> {{ $contactMessage->email }}</li>
        <li><strong>WhatsApp:</strong> {{ $contactMessage->whatsapp ?: 'Non renseigne' }}</li>
        <li><strong>Entreprise:</strong> {{ $contactMessage->entreprise ?: 'Non renseignee' }}</li>
