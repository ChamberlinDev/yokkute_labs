...
class SiteSettingController extends Controller
{
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'home_badge_text_en' => ['nullable', 'string', 'max:255'],
            'home_hero_title' => ['required', 'string'],
            'home_hero_title_en' => ['nullable', 'string'],
            'home_hero_sub' => ['required', 'string'],
            'home_hero_sub_en' => ['nullable', 'string'],
            'home_primary_cta_label' => ['required', 'string', 'max:255'],
            'home_primary_cta_label_en' => ['nullable', 'string', 'max:255'],
            'home_primary_cta_url' => ['required', 'string', 'max:255'],
            'home_primary_cta_url_en' => ['nullable', 'string', 'max:255'],
            'home_secondary_cta_label' => ['required', 'string', 'max:255'],
            'home_secondary_cta_label_en' => ['nullable', 'string', 'max:255'],
            'home_secondary_cta_url' => ['required', 'string', 'max:255'],
            'home_secondary_cta_url_en' => ['nullable', 'string', 'max:255'],
